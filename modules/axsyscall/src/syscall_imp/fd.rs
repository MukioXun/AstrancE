...
#[cfg(feature = "fd")]
pub fn ax_close(fd: c_int) -> SyscallResult {
...
#[cfg(feature = "fd")]
pub fn ax_dup(old_fd: c_int) -> SyscallResult {
...
pub fn ax_dup2(old_fd: c_int, new_fd: c_int) -> SyscallResult {
...
#[cfg(feature = "fd")]
pub fn ax_fcntl(fd: c_int, cmd: c_int, arg: usize) -> SyscallResult {
