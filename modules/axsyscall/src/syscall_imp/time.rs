...
pub fn ax_clock_gettime(clk: ctypes::clockid_t, ts: *mut ctypes::timespec) -> SyscallResult {
...
pub fn ax_nanosleep(req: *const ctypes::timespec, rem: *mut ctypes::timespec) -> SyscallResult {
...
pub fn ax_get_time_of_day(ts: *mut ctypes::timeval) -> SyscallResult {
